...
| 5 | Tighten chapter prose for publication | After P6 |
| 6 | Contact Extropic / Normal Computing with mdbook link | After prose pass |

## Parallel Track (not blocking paper)

| # | Item | Status |
|---|------|--------|
| 7 | cf-design `param_gradient → mass_properties` wiring | Not started |
| 8 | cf-design ↔ sim-ml-chassis AD bridge | Not started |
| 9 | Sim Phases 7-11 — specs in `sim/docs/todo/` | Not started |
| 10 | Actuator examples visual review (2-10 of 10) | 40/40 PASS, needs visual review |
| 11 | GPU physics pipeline — spec at `sim/docs/GPU_PHYSICS_PIPELINE_SPEC.md` | Specced, not implemented |
| 12 | Item 10 grade sweep — 10/12 crates remaining | Deferred to post-ThermCircuitEnv |

## Later Experiments (after paper ships)

| # | Item | Gap |
|---|------|-----|
| 13 | P1 — Topological encoding | Can design now (P4 δ* known), needs amplitude invariance test |
