...
- **Wrinkles are reconstructed as shader-side bump fields driven by contact pressure.** The mathematical construction is [Blinn 1978](../../appendices/00-references/04-rendering.md#blinn-1978) bump mapping; the novel part is the physics-coupled bump signal, which has no established precedent in published rendering literature.
