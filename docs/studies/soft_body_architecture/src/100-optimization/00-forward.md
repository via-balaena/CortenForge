...
- **Boundary and contact** — prescribed displacement magnitudes, contact-friction coefficient $\mu_c$, contact-partner kinematic parameters (probe radius / orientation, driven by [`sim-mjcf`](../110-crate/02-coupling/00-mjcf.md)).
