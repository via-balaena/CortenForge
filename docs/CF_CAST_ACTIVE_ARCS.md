...
- **Recon:** `docs/CF_CAST_SEAM_FLANGE_RECON.md` (+ cold-read
  pass-1 applied).
- **State:** **S1 shipped (`8997bdd3`) + cold-read pass-1 (`746a75bc`) + S2 shipped (`3f50689e`) + S3 shipped (`9574f46f`) + S3 cold-read pass-1 (`a4af6b25`) + S3 cold-read pass-2 (`e757551d`).** S4-S5 pending.
