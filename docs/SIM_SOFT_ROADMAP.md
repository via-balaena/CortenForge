...
- ⏳ k-nearest-tet weighted scalar interp — C2.1 ships categorical-stays-integer dispatch (suffix `_id` → nearest-tet, k=1; position-based winner on slab_cut); C2.2 kNN-IDW continuous smoothing still ahead
