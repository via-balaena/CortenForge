...
and prints a validation report to the console. 151 examples across 27 domains.
...
| [`mesh-collision/`](mesh-collision/) | 8 | All 7 mesh collision pairs (BVH + GJK/EPA) + stress-test |
