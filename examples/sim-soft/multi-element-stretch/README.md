...
- **`HandBuiltTetMesh::uniform_block`**: `sim/L0/soft/src/mesh/hand_built.rs:281-310` — compressive-block constructor; this is its first user-facing example consumer (the invariant tests use it for compressive-block scenes).
