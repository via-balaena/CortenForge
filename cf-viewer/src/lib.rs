...
mod tests {
    ...
    ///
    /// Synthetic rather than fixture-based: the natural `sphere_eval`
    /// fixture under `examples/sim-soft/sdf/stress-test/out/` is gitignored
    /// and regenerated by `cargo run -p example-sdf-stress-test`. The user-facing
