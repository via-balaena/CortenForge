...
/// One silicone layer's card — the grey the pre-port used for step 5's parts
/// box. Cool where the ridge cards are warm, and these sit on the panel rather
/// than inside an enclosing card. ⚠ The pre-port's layer rows had no card.
