...
//!
//! [`generate_procedure_markdown_v2`] renders a workshop-ready Markdown
...
//! bit-exactly. [`CastSpec::write_procedure_v2`] is the convenience
...
///
/// Renders v2's 2-piece-per-layer geometry (per
...
///
/// The same pour-volume computation drives the budget gate in
/// [`CastSpec::export_molds_v2`].
///
