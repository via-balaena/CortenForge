...
pub fn collide_with_sdf(
    ...
    if model.geom_type[other_geom] == GeomType::Sdf {
        ...
        // Three-tier CPU dispatch, all handled inside compute_shape_contact:
        ...
        // 3. Grid fallback → sdf_sdf_contact_raw_split (per-shape refined)
        let mut sdf_contacts = compute_shape_contact(
            shape_a,
            &sdf_pose,
            shape_b,
            &other_pose,
        ...
        // already sparse. It applies to Tier 3 (grid) contacts.
