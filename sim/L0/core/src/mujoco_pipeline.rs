...
// compute_point_velocity: no longer re-imported — only called from constraint/equality.rs internally
use crate::constraint::impedance::ball_limit_axis_angle; // monolith: removed in Phase 6 step 5
use crate::constraint::impedance::compute_aref; // monolith: removed in Phase 6 step 5
use crate::constraint::impedance::compute_diag_approx_exact; // monolith: removed in Phase 6 step 5
use crate::constraint::impedance::compute_impedance; // monolith: removed in Phase 6 step 5
use crate::constraint::impedance::compute_kbip; // monolith: removed in Phase 6 step 5
use crate::constraint::impedance::compute_regularization; // monolith: removed in Phase 6 step 5
// mj_solve_sparse_vec: no longer re-imported — only called from constraint/impedance.rs internally
...
use crate::constraint::impedance::normalize_quat4; // monolith: removed in Phase 6 step 5
// quaternion_to_axis_angle: no longer re-imported — only called from constraint/equality.rs internally
// add_body_angular_jacobian_row, add_body_point_jacobian_row: no longer re-imported —
// only called from within constraint/equality.rs internally
use crate::constraint::equality::extract_connect_jacobian; // monolith: removed in Phase 6 step 5
use crate::constraint::equality::extract_distance_jacobian; // monolith: removed in Phase 6 step 5
use crate::constraint::equality::extract_joint_equality_jacobian; // monolith: removed in Phase 6 step 5
use crate::constraint::equality::extract_tendon_equality_jacobian; // monolith: removed in Phase 6 step 5
use crate::constraint::equality::extract_weld_jacobian; // monolith: removed in Phase 6 step 5
// EqualityConstraintRows: no longer re-imported — type inferred at call sites
use crate::constraint::jacobian::compute_contact_jacobian; // monolith: removed in Phase 6 step 5
...
#[inline]
pub(crate) fn tendon_deadband_displacement(length: f64, range: [f64; 2]) -> f64 {
...
pub(crate) fn assemble_unified_constraints(
    model: &Model,
    data: &mut Data,
...
pub(crate) fn compute_qfrc_constraint_from_efc(model: &Model, data: &mut Data) {
    let nv = model.nv;
    data.qfrc_constraint.fill(0.0);
    let nefc = data.efc_type.len();
    for i in 0..nefc {
...
pub(crate) fn extract_qfrc_frictionloss(data: &mut Data, nv: usize) {
