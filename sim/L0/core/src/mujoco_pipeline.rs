...
use crate::constraint::solver::hessian::NV_SPARSE_THRESHOLD; // monolith: removed in Phase 6 step 11
use crate::constraint::solver::hessian::SparseHessian;
use crate::constraint::solver::hessian::assemble_hessian; // monolith: removed in Phase 6 step 11
use crate::constraint::solver::hessian::hessian_cone; // monolith: removed in Phase 6 step 11
use crate::constraint::solver::hessian::hessian_incremental; // monolith: removed in Phase 6 step 11
use crate::constraint::solver::pgs::classify_constraint_states; // monolith: removed in Phase 6 step 9/11
...
use crate::constraint::solver::primal::primal_search; // monolith: removed in Phase 6 step 11 // monolith: removed in Phase 6 step 11
// ============================================================================
...
#[inline]
pub(crate) fn tendon_active_stiffness(k: f64, length: f64, range: [f64; 2]) -> f64 {
    if k <= 0.0 {
        return 0.0;
    }
...
pub(crate) fn project_elliptic_cone(lambda: &mut [f64], mu: &[f64; 5], dim: usize) {
...
// Moved to constraint/solver/pgs.rs: compute_delassus_regularized, pgs_solve_unified

// =============================================================================

// Moved to constraint/solver/cg.rs: cg_solve_unified

// Moved to constraint/solver/pgs.rs: pgs_cost_change
...
// Moved to constraint/solver/pgs.rs: classify_constraint_states

// Moved to constraint/solver/hessian.rs: assemble_hessian, NV_SPARSE_THRESHOLD,
// SparseHessian (struct + impl), hessian_incremental, hessian_cone
