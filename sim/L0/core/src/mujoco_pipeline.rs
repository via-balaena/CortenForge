...
pub(crate) use crate::dynamics::DEFAULT_MASS_FALLBACK;
...
use crate::constraint::compute_point_velocity; // monolith: removed in Phase 12
...
use crate::constraint::impedance::quaternion_to_axis_angle; // monolith: removed in Phase 6 step 5
...
// Local copy retained for get_min_diagonal_mass (will move to constraint/equality.rs in Phase 6 step 4).
