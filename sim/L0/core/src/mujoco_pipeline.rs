...
use nalgebra::{
    DMatrix, DVector, Matrix3, Matrix6, Point3, UnitQuaternion, Vector2, Vector3, Vector6,
};
use sim_types::Pose;
...
pub(crate) use crate::dynamics::shift_spatial_inertia;
pub(crate) use crate::dynamics::spatial_cross_force;
pub(crate) use crate::dynamics::spatial_cross_motion;
...
pub(crate) use crate::joint_visitor::joint_motion_subspace;
...
pub(crate) fn geom_to_collision_shape(
    geom_type: GeomType,
    size: Vector3<f64>,
...
// Moved to joint_visitor.rs: joint_motion_subspace
