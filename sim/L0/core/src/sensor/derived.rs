//! Derived sensor computations — body acceleration, angular acceleration,
//! site force/torque via subtree inverse dynamics.
//!
//! Subtree COM, linear velocity, and angular momentum are now persistent
//! `Data` fields computed by `mj_com_pos` / `mj_subtree_vel` respectively,
//! not helper functions here.
