//! MJCF model builder — inline tests only.
//!
//! All production code has been extracted to `crate::builder` sub-modules
//! (Phase 10). This file retains inline tests that exercise the full
//! model-building pipeline. It will be reorganised in Phase 12.
...
#[cfg(test)]
use sim_core::{ActuatorDynamics, ActuatorTransmission, BiasType, GainType, GeomType, MjJointType};
