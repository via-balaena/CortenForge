...
// Re-import from builder/ (build() impl block lives here until Phase 12)
...
// process_tendons → crate::builder::tendon (Phase 10)
// process_actuator → crate::builder::actuator (Phase 10)
// process_sensors, resolve_sensor_object → crate::builder::sensor (Phase 10)

// process_contact → crate::builder::contact (Phase 10)
// process_equality_constraints, compute_initial_geom_distance, geom_world_position
// → crate::builder::equality (Phase 10)
// process_flex_bodies → crate::builder::flex (Phase 10)
...
// parse_gaintype, parse_biastype, parse_dyntype, floats_to_array
// → crate::builder::actuator (Phase 10)
...
// convert_sensor_type, sensor_datatype → crate::builder::sensor (Phase 10)

#[cfg(test)]
use crate::builder::compiler::apply_fusestatic;
#[cfg(test)]
use crate::builder::flex::compute_vertex_masses;
#[cfg(test)]
use crate::builder::geom::compute_geom_inertia;
#[cfg(test)]
use crate::builder::mesh::{convert_mjcf_mesh, load_mesh_file};
#[cfg(test)]
use crate::types::{MjcfCompiler, MjcfFlex, MjcfGeom, MjcfGeomType, MjcfMesh};
#[cfg(test)]
use sim_core::{ActuatorDynamics, BiasType, GainType, GeomType, MjJointType};

// compute_flexedge_crosssection, compute_flex_address_table, compute_flex_count_table,
// compute_vertex_masses, compute_dihedral_angle, compute_edge_solref,
// compute_bend_stiffness_from_material, compute_bend_damping_from_material
// → crate::builder::flex (Phase 10)
use crate::builder::flex::{
