...
- **3A-v Constraint/Joint + Physics** (#38–41, §42A-i–iii): ~~ball/free joint limits~~ ✅, ~~`wrap_inside`~~ ✅, ~~fluid forces~~ ✅, ~~tendon visualization data (§40b)~~ ✅, `disableflags`, flex edge Jacobian (§42A-i), flex rigid flags (§42A-ii), flex pre-computed fields (§42A-iii) (~~#42 flex/flexcomp~~ subsumed by §6B)
