...
- Spatial tendon pipeline ✅ — 3D routing with `mj_fwd_tendon_spatial()`, sphere/cylinder wrapping, sidesite disambiguation, `wrap_inside` inverse wrapping (§39), pulley divisors, free-joint Jacobians, `accumulate_point_jacobian()`, 31 acceptance tests verified against MuJoCo 3.4.0 + 13 wrap_inside tests against MuJoCo 3.5.0 ([future_work_2 #4](./todo/future_work_2.md), [future_work_10 §39](./todo/future_work_10.md))
