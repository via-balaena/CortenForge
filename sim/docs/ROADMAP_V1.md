...
|------|--------|------|-------------|
| DT-74 | 10j | T3 | `compute_body_jacobian_at_point()` incomplete — only x-component implemented |
| DT-75 | 10j | T3 | `add_body_jacobian` free joint bug — world-frame vectors instead of body-frame `R*e_i` |
