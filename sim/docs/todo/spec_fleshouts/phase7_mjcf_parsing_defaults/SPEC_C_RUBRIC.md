...
| §55 umbrella says 7 types | MuJoCo also supports `cam_user`/`nuser_cam` (camera user data). The umbrella and session plan explicitly list 7 types only. | **Camera out of scope** — track as DT-126 if needed |
