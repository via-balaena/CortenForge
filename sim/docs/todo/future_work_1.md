...
Tracked in [future_work_9b.md](./future_work_9b.md) §DT-36.
...
it matters. Tracked in [future_work_9b.md](./future_work_9b.md) §DT-37.
...
Tracked in [future_work_9b.md](./future_work_9b.md) §DT-38.
...
- Fixed tendons have **constant Jacobians** (the coupling coefficients), eliminating
  ...
  Tracked in [future_work_9b.md](./future_work_9b.md) §DT-74.
...
Tracked in [future_work_9b.md](./future_work_9b.md) §DT-28.
...
for t in 0..model.ntendon {
    ...
    // solver. Tracked in future_work_9b.md §DT-35.
...
appropriate path. Tracked in [future_work_9b.md](./future_work_9b.md) §DT-29.
...
- `sim-muscle`'s richer Hill model (compliant tendons, pennation geometry, Newton
  ...
  Tracked in [future_work_9b.md](./future_work_9b.md) §DT-58.
...
pub fn compute_muscle_params(&mut self) {
    ...
    // Tracked in future_work_9b.md §DT-59.
...
4. **Frame sensor `objtype` attribute parsing** — MuJoCo frame sensors support
   ...
   Tracked in [future_work_9b.md](./future_work_9b.md) §DT-62.
...
5. **Frame sensor `reftype`/`refid`** — MuJoCo frame sensors can measure
   ...
   Tracked in [future_work_9b.md](./future_work_9b.md) §DT-63.
...
6. **Multi-geom Touch bodies** — The Touch sensor wiring (Step 3e) resolves
   ...
   Tracked in [future_work_9b.md](./future_work_9b.md) §DT-64.
...
7. **User sensor `dim` attribute** — MuJoCo's `<user>` sensor element accepts
   ...
   is a follow-up.
   Tracked in [future_work_9b.md](./future_work_9b.md) §DT-65.
...
- The one heap allocation is `efc_lambda.clone()`. For typical contact counts (<100
  ...
  Tracked in [future_work_9b.md](./future_work_9b.md) §DT-76.
...
Tracked in [future_work_9b.md](./future_work_9b.md) §DT-56 (dampratio) and §DT-57 (acc0).
