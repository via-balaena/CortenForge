...
7. Routing: `qfrc_gravcomp` added to `qfrc_passive` at end of `mj_fwd_passive()`.
   ...
   Tracked in [future_work_9b.md](./future_work_9b.md) §DT-60.
...
4. **Gravity disable flag**: MuJoCo checks `mjDISABLED(mjDSBL_GRAVITY)` in
   ...
   Tracked in [future_work_9b.md](./future_work_9b.md) §DT-61.
...
Tracked in [future_work_9b.md](./future_work_9b.md) §DT-72.
