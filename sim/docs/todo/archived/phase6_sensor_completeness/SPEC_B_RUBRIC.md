...
| R4 | P3 | Missing `Camera` variant in `MjObjectType` not called out | Rubric self-audit | Added DT-120 Camera variant gap to P3 bar and EGT-4 | Rev 1 |
