...
/// | 0.08 | drives | **stalls** | 0.669 | 0.703 |
/// | 0.10 | drives | **stalls** | 0.677 | 0.709 |
/// | 0.15 | drives | drives | 0.700 | 0.729 |
/// | 0.20 | drives | drives | 0.724 | 0.748 |
/// | **0.25** | **drives** | **drives** | **0.750** | **0.767** |
/// | 0.40 | drives | drives | 0.836 | 0.831 |
///
...
mod tests {
    ...
    fn curved_tet10_midsides_seat_on_the_endplate_fom() {
        ...
        //   ALL candidates   straight max 12.464 rms 3.375  ->  curved max 12.464 rms 3.357
        ...
        //
        // **32.6 % of the authorised midsides do NOT reach their full projection**, and that is
        ...
        // not a bug — a midside asked to move 1.533 mm across a 3 mm cell is asked to fold its
        // element, and the quality floor refuses. Compare the corner conform, where 230 of 233
